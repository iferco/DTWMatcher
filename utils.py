...
def get_position(list,composition, movement):
    """
    Param: list of tuples and  composition, movement of the wanted element.
    Returns: position of the element in the list. Or -1 if not found.
    """
